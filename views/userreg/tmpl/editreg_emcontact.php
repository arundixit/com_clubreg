...
<div class="taghd"><?php echo EMERGENCY; ?> Details</div>
		<div class="n  fleft">
		<label class="lbcls" for="em_surname">Surname</label><?php echo $colon ;?><input type="text" class="intext" name="em_surname" id="em_surname" value="<?php echo $emcontact->surname;	?>"/>
		</div>
		<div class="n fleft">
		<label class="lbcls" for="em_givenname"><?php echo GIVENNAME; ?></label><?php echo $colon ;?><input type="text" class="intext" name="em_givenname" id="em_givenname" value="<?php echo $emcontact->givenname;	?>"/>
		</div>
		<div class="n"><p class="cl"></p>
		<label class="lbcls" for="em_emailaddress">Email-Address</label><?php echo $colon ;?><input type="text"  class="intext validate-email" name="em_emailaddress" id="em_emailaddress" value="<?php echo $emcontact->emailaddress;?>"/>
		</div>			
		<div class="n  fleft">
